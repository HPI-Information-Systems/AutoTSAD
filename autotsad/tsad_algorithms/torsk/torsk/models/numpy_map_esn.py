...
from .initialize import dense_esn_reservoir, sparse_nzpr_esn_reservoir
from ..data.conv import get_kernel
from ..data.dct import dct2
from ..data.utils import resample2d, normalize
from ..numpy_accelerate import bh, to_np, to_bh, bh_dot
...
def init_input_map_specs(input_map_specs, input_shape, dtype):
    input_map_specs = copy.deepcopy(input_map_specs)
